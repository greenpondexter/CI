...
export default class MemberProfile extends React.Component{
  ...
  shouldComponentUpdate(nextProps, nextState){
      return nextProps.summaryData.size > 0 ? true : false; 
  }
            ...
            <Col md={3}></Col>
               <Col md={2}>
                  <AltContainer stores = {[ProfileDataStore]}
                    ...
                    <HcgBreakdownPieChart/>
                  </AltContainer>
               </Col>
               <Col md={2}>
                  <AltContainer stores = {[ProfileDataStore]}
                    inject = {{
                        drgData : () => ProfileDataStore.getState().drgData
                    }} >
                    <DrgBarChart/>
                  </AltContainer>
               </Col>
               <Col md={2}>
                  <AltContainer stores = {[ProfileDataStore]}
                    inject = {{
                        icdDiagData : () => ProfileDataStore.getState().icdDiagData
                    }} >
                    <IcdDiagBarChart/>
                  </AltContainer>
               </Col>
...
MemberProfile.propTypes = {
    summaryData : React.PropTypes.object,
    hcgData : React.PropTypes.object, 
    member_name : React.PropTypes.string
