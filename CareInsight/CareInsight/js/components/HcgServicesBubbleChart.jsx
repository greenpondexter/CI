...
export default class HcgServicesBubbleChart extends React.Component{
    constructor(props){
        super(props);
	...
	buildChart(){
        ...
        const data = this.props.hcgData.toJS();
       ...
       //believe this is for setting domain of the main chart when slider has been updated
		...
		var	circles = itemRects.selectAll("circle")
                    ...
                    .attr("r", function (d) {return (60*.5*(d.paid/data.maxPaid[0]))})
...
HcgServicesBubbleChart.propTypes = {
    hcgData : ImmutablePropTypes.list,
